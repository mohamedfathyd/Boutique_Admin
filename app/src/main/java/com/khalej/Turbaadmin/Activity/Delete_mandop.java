...
public class Delete_mandop extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_Deletetager recyclerAdapter_secondry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_mandop);
    ...
    public void fetchInfo() {
        ...
        Call<List<contact_userinfo>> call = apiinterface.get_all_mandop();
        call.enqueue(new Callback<List<contact_userinfo>>() {
            ...
            public void onResponse(Call<List<contact_userinfo>> call, Response<List<contact_userinfo>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_Deletetager(Delete_mandop.this, contactList);
