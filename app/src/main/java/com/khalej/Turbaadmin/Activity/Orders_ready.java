...
import com.khalej.Turbaadmin.Adapter.RecyclerAdapter_recervations_ready;
...
public class Orders_ready extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_recervations_ready recyclerAdapter_secondry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orders_ready);
        progressBar = (ProgressBar) findViewById(R.id.progressBar_subject);
        textView = (TextView) findViewById(R.id.toolbar_title);
        progressBar.setVisibility(VISIBLE);
        toolbar = (Toolbar) findViewById(R.id.app_bar);
        intent = getIntent();
        mandopName=intent.getStringExtra("name");
    ...
    public void fetchInfo() {
        ...
        Call<List<contact_order>> call = apiinterface.get_all_ready_orders();
        call.enqueue(new Callback<List<contact_order>>() {
            ...
            public void onResponse(Call<List<contact_order>> call, Response<List<contact_order>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_recervations_ready (Orders_ready.this, contactList,mandopName);
