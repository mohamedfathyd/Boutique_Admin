...
public class Orders_By_Day extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orders__by__day);
    ...
    public void fetchInfo() {
        ...
        Call<List<contact_order>> call = apiinterface.get_all_neworders_day(date);
        call.enqueue(new Callback<List<contact_order>>() {
            ...
            public void onResponse(Call<List<contact_order>> call, Response<List<contact_order>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_recervations_withMandop_(Orders_By_Day.this, contactList);
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    ...
                    writer.flush();
                    writer.close();
                    Toast.makeText(Orders_By_Day.this,"تم الحفظ فى ملفات الهاتف " , Toast.LENGTH_LONG).show();
