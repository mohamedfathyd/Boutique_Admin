...
public class Image_inside_offer extends AppCompatActivity {
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_inside_offer);
    ...
    public void fetchInfo(){
        progressDialog = ProgressDialog.show(Image_inside_offer.this,"جارى أضافة الصورة العرض","Please wait...",false,false);
        progressDialog.show();
        String image = convertToString();

        apiinterface= Apiclient_home.getapiClient().create(apiinterface_home.class);
        Call<ResponseBody> call = apiinterface.getcontacts_add_Image_offer(id,image);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                AlertDialog.Builder dlgAlert  = new AlertDialog.Builder(Image_inside_offer.this);
                dlgAlert.setMessage("تم أضافة الصورة داخل العرض ");
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(Image_inside_offer.this,t.toString(),Toast.LENGTH_LONG).show();
            }
        });
    }
}
