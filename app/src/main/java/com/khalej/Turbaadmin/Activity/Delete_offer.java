...
import com.khalej.Turbaadmin.Adapter.RecyclerAdapter_Deleteoffer;
...
public class Delete_offer extends AppCompatActivity {
    ...
    private RecyclerAdapter_Deleteoffer recyclerAdapter_secondry;
    ...
    public void fetchInfo() {
        ...
        call.enqueue(new Callback<List<contact_offer>>() {
            ...
            public void onResponse(Call<List<contact_offer>> call, Response<List<contact_offer>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_Deleteoffer(Delete_offer.this, contactList);
