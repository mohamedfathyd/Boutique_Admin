...
public class Add_second_category_tager extends AppCompatActivity {
        ...
        public void fetchInfo(){
            ...
            progressDialog = ProgressDialog.show(Add_second_category_tager.this,"جارى تسجيل المنتج الجديد","Please wait...",false,false);
            progressDialog.show();
            apiinterface= Apiclient_home.getapiClient().create(apiinterface_home.class);
            Call<ResponseBody> call = apiinterface.getcontacts_add_category(marketid,textInputEditTextname.getText().toString()
            ...
            call.enqueue(new Callback<ResponseBody>() {
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    ...
                    dlgAlert.setMessage("تم تسجيل المنتج الجديد بنجاح ");
