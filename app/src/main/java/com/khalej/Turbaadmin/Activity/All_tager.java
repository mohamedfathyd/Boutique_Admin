...
import com.khalej.Turbaadmin.Adapter.RecyclerAdapter_Deletetager;
import com.khalej.Turbaadmin.Adapter.RecyclerAdapter_all_tager;
...
public class All_tager extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_all_tager recyclerAdapter_secondry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_tager);
    ...
    public void fetchInfo() {
        ...
        Call<List<contact_userinfo>> call = apiinterface.get_all_tager();
        call.enqueue(new Callback<List<contact_userinfo>>() {
            ...
            public void onResponse(Call<List<contact_userinfo>> call, Response<List<contact_userinfo>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_all_tager(All_tager.this, contactList);
