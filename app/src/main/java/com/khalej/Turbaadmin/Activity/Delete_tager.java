...
public class Delete_tager extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delete_tager);
    ...
    public void fetchInfo() {
        ...
        call.enqueue(new Callback<List<contact_userinfo>>() {
            ...
            public void onResponse(Call<List<contact_userinfo>> call, Response<List<contact_userinfo>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_Deletetager(Delete_tager.this, contactList);
