...
public class All_mandop extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_mandop);
    ...
    public void fetchInfo() {
        ...
        call.enqueue(new Callback<List<contact_userinfo>>() {
            ...
            public void onResponse(Call<List<contact_userinfo>> call, Response<List<contact_userinfo>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_all_tager(All_mandop.this, contactList);
