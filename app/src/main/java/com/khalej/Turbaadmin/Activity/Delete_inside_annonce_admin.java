...
public class Delete_inside_annonce_admin extends AppCompatActivity {
    Toolbar toolbar;
    ...
    public void fetchInfo() {
        ...
        Call<List<contact_second_home>> call = apiinterface.getcontacts_del_admin();
        call.enqueue(new Callback<List<contact_second_home>>() {
            ...
            public void onResponse(Call<List<contact_second_home>> call, Response<List<contact_second_home>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_DeleteInsideAnnonce(Delete_inside_annonce_admin.this, contactList);
