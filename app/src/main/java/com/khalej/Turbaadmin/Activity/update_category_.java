...
public class update_category_ extends AppCompatActivity {
    Intent intent;
    ...
    public void fetchInfo(){
        ...
        try{
         image = convertToString();}
            ...
            Toast.makeText(update_category_.this,"من فضلك اختر صورة" , Toast.LENGTH_LONG).show();
            regesiter.setClickable(true);
            return;

        }
        progressDialog = ProgressDialog.show(update_category_.this,"جارى تعديل القسم ","Please wait...",false,false);
        progressDialog.show();
        apiinterface= Apiclient_home.getapiClient().create(apiinterface_home.class);
        Call<ResponseBody> call = apiinterface.getcontacts_update_first_category(id,textInputEditTextname.getText().toString()
                ,image, ((int) spinner.getSelectedItemId()+1));
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                AlertDialog.Builder dlgAlert  = new AlertDialog.Builder(update_category_.this);
                dlgAlert.setMessage("تم تعديل القسم بنجاح ");
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(update_category_.this,t.toString(),Toast.LENGTH_LONG).show();
            }
        });
    }
}
