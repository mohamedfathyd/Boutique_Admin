...
public class Update_Inside_Annonce_ extends AppCompatActivity {
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update__inside__annonce_);
        ...
        tagername=intent.getStringExtra("tagername");
        textInputEditTextlink.setText(intent.getStringExtra("price"));
        textInputEditTextname.setText(intent.getStringExtra("name"));
        textInputEditTexttext.setText(intent.getStringExtra("descriptin"));
    ...
    public void fetchInfo(){
        ...
        try{
            ...
            Toast.makeText(Update_Inside_Annonce_.this,"من فضلك اختر صورة" , Toast.LENGTH_LONG).show();
            regesiter.setClickable(true);
            return;

        }
        progressDialog = ProgressDialog.show(Update_Inside_Annonce_.this,"جارى تعديل المنتج ","Please wait...",false,false);
        progressDialog.show();
        apiinterface= Apiclient_home.getapiClient().create(apiinterface_home.class);
        Call<ResponseBody> call = apiinterface.getcontacts_update_category(id,marketid,textInputEditTextname.getText().toString()
                ,image,textInputEditTextlink.getText().toString(),textInputEditTexttext.getText().toString(),tagername
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                AlertDialog.Builder dlgAlert  = new AlertDialog.Builder(Update_Inside_Annonce_.this);
                dlgAlert.setMessage("تم تعديل المنتج  بنجاح ");
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(Update_Inside_Annonce_.this,t.toString(),Toast.LENGTH_LONG).show();
            }
        });
    }
}
