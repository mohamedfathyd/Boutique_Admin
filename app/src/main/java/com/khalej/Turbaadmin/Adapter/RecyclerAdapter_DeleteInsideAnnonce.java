...
import com.khalej.Turbaadmin.Activity.Add_Image;
...
public class RecyclerAdapter_DeleteInsideAnnonce extends RecyclerView.Adapter<RecyclerAdapter_DeleteInsideAnnonce.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<contact_second_home> contactslist;
    apiinterface_home apiinterface;

    public RecyclerAdapter_DeleteInsideAnnonce(Context context, List<contact_second_home> contactslist) {
