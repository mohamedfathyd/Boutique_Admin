...
public class RecyclerAdapter_allfirstupdate extends RecyclerView.Adapter<RecyclerAdapter_allfirstupdate.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<contact_home> contactslist;
     apiinterface_home apiinterface;
    public RecyclerAdapter_allfirstupdate(Context context, List<contact_home> contactslist){
    ...
    holder.Name.setText(contactslist.get(position).getname());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(context, update_category_.class);
