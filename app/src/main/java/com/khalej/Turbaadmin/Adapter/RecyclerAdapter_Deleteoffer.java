...
public class RecyclerAdapter_Deleteoffer extends RecyclerView.Adapter<RecyclerAdapter_Deleteoffer.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<contact_offer> contactslist;
    apiinterface_home apiinterface;

    public RecyclerAdapter_Deleteoffer(Context context, List<contact_offer> contactslist) {
    ...
    public void fetchInfo(int id) {
        ...
        call=apiinterface.delete_first_offer(id);
