...
public class RecyclerAdapter_Deletetager extends RecyclerView.Adapter<RecyclerAdapter_Deletetager.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<contact_userinfo> contactslist;
    apiinterface_home apiinterface;

    public RecyclerAdapter_Deletetager(Context context, List<contact_userinfo> contactslist) {
