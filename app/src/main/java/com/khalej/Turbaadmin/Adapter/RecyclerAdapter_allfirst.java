...
public class RecyclerAdapter_allfirst extends RecyclerView.Adapter<RecyclerAdapter_allfirst.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<contact_home> contactslist;
     apiinterface_home apiinterface;
    public RecyclerAdapter_allfirst(Context context, List<contact_home> contactslist){
