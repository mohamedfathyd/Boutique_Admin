...
import com.khalej.Turbaadmin.Activity.Update_Inside_Annonce;
import com.khalej.Turbaadmin.Activity.Update_Inside_Annonce_;
...
public class RecyclerAdapter_UpdateInsideAnnonce extends RecyclerView.Adapter<RecyclerAdapter_UpdateInsideAnnonce.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<contact_second_home> contactslist;
    apiinterface_home apiinterface;
    String tagername;int marketid;
    public RecyclerAdapter_UpdateInsideAnnonce(Context context, List<contact_second_home> contactslist,String tagername,int marketid) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context, Update_Inside_Annonce_.class);
                intent.putExtra("name",contactslist.get(position).getname());
                intent.putExtra("marketid",marketid);
                intent.putExtra("tagername",tagername);
                intent.putExtra("price",contactslist.get(position).getLink());
                intent.putExtra("descriptin",contactslist.get(position).getText());
    ...
    public void fetchInfo(int id) {
        ...
        call=apiinterface.delete_InsideAnnonce(id);
