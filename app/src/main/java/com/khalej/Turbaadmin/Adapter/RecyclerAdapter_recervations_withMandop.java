...
public class RecyclerAdapter_recervations_withMandop extends RecyclerView.Adapter<RecyclerAdapter_recervations_withMandop.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<contact_order> contactslist;
    apiinterface_home apiinterface;

    public RecyclerAdapter_recervations_withMandop(Context context, List<contact_order> contactslist){
