...
import com.khalej.Boutiqueadmin.Adapter.RecyclerAdapter_Imagesecond;
...
public class Image_inside_category extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_Imagesecond recyclerAdapter_secondry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_inside_category);
    ...
    public void fetchInfo() {
        ...
        call.enqueue(new Callback<List<contact_second_home>>() {
            ...
            public void onResponse(Call<List<contact_second_home>> call, Response<List<contact_second_home>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_Imagesecond(Image_inside_category.this, contactList);
