...
import com.khalej.Boutiqueadmin.Adapter.RecyclerAdapter_alltager;
...
public class Tager_orders extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_alltager recyclerAdapter_secondry;
    ...
    public void fetchInfo() {
        ...
        call.enqueue(new Callback<List<contact_tager>>() {
            ...
            public void onResponse(Call<List<contact_tager>> call, Response<List<contact_tager>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_alltager(Tager_orders.this, contactList);
