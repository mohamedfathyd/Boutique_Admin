...
public class Add_second_category_tager extends AppCompatActivity {
    ...
    public void initializer(){
        ...
        textInputEditTextnametager=findViewById(R.id.textInputEditTextnametager);
    ...
    public void fetchInfo(){
        ...
        Call<ResponseBody> call = apiinterface.getcontacts_add_category(category_id,textInputEditTextname.getText().toString()
                ,image,textInputEditTextlink.getText().toString(),textInputEditTexttext.getText().toString(),
                textInputEditTextnametager.getText().toString()
