...
public class Add_second_category extends AppCompatActivity {
    ...
    public void fetchInfo(){
        ...
        progressDialog = ProgressDialog.show(Add_second_category.this,"جارى تسجيل المنتج الجديد","Please wait...",false,false);
        progressDialog.show();
        ...
        Call<ResponseBody> call = apiinterface.getcontacts_add_category(category_id,textInputEditTextname.getText().toString()
                ,image,textInputEditTextlink.getText().toString(),textInputEditTexttext.getText().toString(),"الادمن");
